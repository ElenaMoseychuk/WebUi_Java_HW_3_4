...
public class CheckProfile {
    ...
    private static CheckProfile checkProfile;
...
//        options.addArguments("--headless");
        ...
        closeCookie.click();
        WebElement webElement1 = driver.findElement(By.cssSelector(".s-header-item--user"));
        webElement1.click();
        WebElement webElement2 = driver.findElement(By.cssSelector(".s-header-item > .b-flatbutton"));
        webElement2.click();
        WebElement webElement3 = driver.findElement(By.cssSelector(".s-header-sub-list-item__link--profile"));
        webElement3.click();
        driver.quit();
    }
